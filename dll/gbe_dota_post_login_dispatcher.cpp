...
registry::View Steam_Game_Coordinator::GBE_ProductionDotaHandlerRegistry()
{
    ...
    auto adapt_direct_7034 = +[](Steam_Game_Coordinator *self, const gbe::dota_gc_router::DotaGcRequestContext &c, const std::string *) -> bool { return c.path == gbe::dota_gc_router::DotaGcRequestPath::Direct && self->GBE_HandleDotaDirect7034Request(c.inner_emsg, reinterpret_cast<const uint8 *>(c.body.data()), c.body.size(), c.has_request_job, c.request_job_id); };
    auto adapt_direct_equip_items = +[](Steam_Game_Coordinator *self, const gbe::dota_gc_router::DotaGcRequestContext &c, const std::string *) -> bool { return c.path == gbe::dota_gc_router::DotaGcRequestPath::Direct && self->GBE_HandleDotaEquipItemsRequest(reinterpret_cast<const uint8 *>(c.body.data()), c.body.size(), c.has_request_job, c.request_job_id); };
    auto adapt_abandon_current_game = +[](Steam_Game_Coordinator *self, const gbe::dota_gc_router::DotaGcRequestContext &c, const std::string *sess) -> bool { return self->GBE_HandleDotaAbandonCurrentGameRequest(c.wrapped, sess); };
    auto adapt_game_match_sign_out = +[](Steam_Game_Coordinator *self, const gbe::dota_gc_router::DotaGcRequestContext &c, const std::string *sess) -> bool { return self->GBE_HandleDotaGameMatchSignOutRequest(c.wrapped, sess, c.has_request_job, c.request_job_id); };
    auto adapt_destroy_lobby = +[](Steam_Game_Coordinator *self, const gbe::dota_gc_router::DotaGcRequestContext &c, const std::string *sess) -> bool { return self->GBE_HandleDotaDestroyLobbyRequest(c.request_job_id, c.has_request_job, c.wrapped, sess); };
    ...
    static const registry::Entry kTable[] = {
        ...
        { 7034u, registry::RequestMode::Direct, registry::SessionPolicy::Ignore, registry::LifecycleClass::LobbyLifecycle, adapt_direct_7034, registry::HandlerId::Direct7034, "smoke:test_match_7034_host_showcase_repush_guard_marks_once" },
        { 2569u, registry::RequestMode::Direct, registry::SessionPolicy::Ignore, registry::LifecycleClass::LobbyMutation, adapt_direct_equip_items, registry::HandlerId::EquipItems, "smoke:test_inventory_equip_full_forward" },
        { GBE_kDotaAbandonCurrentGame, registry::RequestMode::DirectAndWrapped, registry::SessionPolicy::ForwardWrappedSession, registry::LifecycleClass::LobbyLifecycle, adapt_abandon_current_game, registry::HandlerId::AbandonCurrentGame, "smoke:test_lobby_abandon_current_game_disconnect_queues_25" },
        { GBE_kDotaGameMatchSignOut, registry::RequestMode::DirectAndWrapped, registry::SessionPolicy::ForwardWrappedSession, registry::LifecycleClass::LobbyLifecycle, adapt_game_match_sign_out, registry::HandlerId::GameMatchSignOut, "smoke:test_lobby_game_match_signout_queues_7005_and_postgame" },
        { GBE_kDotaDestroyLobbyRequest, registry::RequestMode::DirectAndWrapped, registry::SessionPolicy::ForwardWrappedSession, registry::LifecycleClass::LobbyLifecycle, adapt_destroy_lobby, registry::HandlerId::DestroyLobby, "smoke:test_lobby_destroy_queues_25_then_8247_and_clears_lobby" },
    };
