...
- [x] 1. Tighten shared lobby read semantics
...
- [x] 2. Name one more lifecycle-specific shared clear intent
  ...
  - [x] 2.2 Add a behavior-equivalent wrapper for one clear intent.
    ...
    - Result: deferred by the stop condition in 2.4; no wrapper added.
  - [x] 2.3 Replace exactly one call site.
    ...
    - Result: deferred by the stop condition in 2.4; no call site replaced.
...
- [x] 3. Extend side-effect recorder coverage before more side-effect seams
...
- [x] 4. Continue response seam naming only where tests already prove metadata
...
- [x] 5. Add client/ownership seam only after coverage is clear
