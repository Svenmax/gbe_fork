# gc-direct-conditional-section-presence-guard tasklist

## Tasks

- [x] Create requirements/design/tasklist spec.
- [x] Mark the slice as WIP in `docs/gc/ACTIVE_QUEUE.md`.
- [x] Make missing fallback §2 fail the direct conditional audit.
...
- [x] Missing fallback §2 does not fall back to whole-document parsing for direct conditional inventory.
