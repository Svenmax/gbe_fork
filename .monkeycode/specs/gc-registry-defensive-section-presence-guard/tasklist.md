# gc-registry-defensive-section-presence-guard tasklist

## Tasks

- [x] Create requirements/design/tasklist spec.
- [x] Mark the slice as WIP in `docs/gc/ACTIVE_QUEUE.md`.
- [x] Make missing template replay §4 fail the registry-defensive audit.
...
- [x] Missing template replay §4 does not fall back to whole-document parsing for registry-defensive inventory.
