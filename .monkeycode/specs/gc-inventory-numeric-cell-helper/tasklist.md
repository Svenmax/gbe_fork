# gc-inventory-numeric-cell-helper tasklist

## Tasks

- [x] Create requirements/design/tasklist spec.
- [x] Add shared numeric Markdown cell helper.
- [x] Replace duplicated single-emsg inventory cell parsing.
...
- [x] Single-emsg inventory cell parsing uses one helper.
