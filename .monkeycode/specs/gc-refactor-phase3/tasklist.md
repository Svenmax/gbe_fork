...
- [ ] 3.1.5 Extract match and misc handlers
  ...
  - [ ] 3.1.5b Create `dll/gbe_dota_post_login_handlers.cpp` for DirectPostLogin / WrappedPostLogin / AddSocket / TemplateReplay / ServerAssignment + template statics.
  - [ ] 3.1.5c Create `dll/gbe_dota_misc_handlers.cpp` for remaining one-off handlers.
