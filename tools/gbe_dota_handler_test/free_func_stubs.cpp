...
uint64_t GBE_dota_host_showcase_equip_generation = 0;
uint64_t GBE_dota_host_showcase_equip_lobby_id = 0;
uint64_t GBE_dota_host_showcase_equip_steam_id = 0;
uint32_t GBE_dota_host_showcase_equip_hero_id = 0;
