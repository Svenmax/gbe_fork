...
""",
    ...
    def test_rejects_direct_parenthesized_field_write(self):
        sources = {
            "gbe_dota_lobby_create_handlers.cpp": "(GBE_local_lobby).state = 1u;",
        }
        self.assertIn(
    ...
    def test_rejects_direct_indexed_field_write(self):
        sources = {
            "gbe_dota_lobby_create_handlers.cpp": "GBE_local_lobby.members[0] = member;",
        }
        self.assertIn(
            "gbe_dota_lobby_create_handlers.cpp: direct GBE_local_lobby field write count 1; route through a named state helper",
            audit.audit_direct_local_lobby_writes(sources),
    ...
    def test_rejects_direct_parenthesized_indexed_field_write(self):
        sources = {
            "gbe_dota_lobby_create_handlers.cpp": "(GBE_local_lobby).members[0] = member;",
        }
        self.assertIn(
    ...
    def test_rejects_direct_indexed_member_write(self):
        sources = {
    ...
    def test_rejects_direct_prefix_indexed_member_write(self):
        sources = {
            "gbe_dota_lobby_create_handlers.cpp": "++GBE_local_lobby.members[0].team;",
        }
        self.assertIn(
            "gbe_dota_lobby_create_handlers.cpp: direct GBE_local_lobby field write count 1; route through a named state helper",
            audit.audit_direct_local_lobby_writes(sources),
    ...
    def test_rejects_direct_postfix_indexed_member_write(self):
        sources = {
            "gbe_dota_lobby_create_handlers.cpp": "GBE_local_lobby.members[0].team++;",
        }
        self.assertIn(
    ...
    def test_rejects_direct_target_prefix_indexed_member_write(self):
        sources = {
            "gbe_dota_custom_game_lifecycle_coordinator.cpp": "++options.client_target->GBE_local_lobby.members[0].team;",
        }
        self.assertIn(
            "gbe_dota_custom_game_lifecycle_coordinator.cpp: direct GBE_local_lobby field write count 1; route through a named state helper",
            audit.audit_direct_local_lobby_writes(sources),
    ...
    def test_rejects_direct_target_postfix_indexed_member_write(self):
        sources = {
            "gbe_dota_custom_game_lifecycle_coordinator.cpp": "options.client_target->GBE_local_lobby.members[0].team++;",
        }
        self.assertIn(
    ...
    def test_rejects_direct_target_prefix_increment_field_write(self):
        sources = {
            "gbe_dota_custom_game_lifecycle_coordinator.cpp": "++options.client_target->GBE_local_lobby.generation;",
        }
        self.assertIn(
            "gbe_dota_custom_game_lifecycle_coordinator.cpp: direct GBE_local_lobby field write count 1; route through a named state helper",
            audit.audit_direct_local_lobby_writes(sources),
    ...
    def test_rejects_direct_indexed_mutating_method_field_write(self):
        sources = {
    ...
    def test_rejects_direct_target_indexed_field_write(self):
        sources = {
            "gbe_dota_custom_game_lifecycle_coordinator.cpp": "options.client_target->GBE_local_lobby.members[0] = member;",
        }
        self.assertIn(
            "gbe_dota_custom_game_lifecycle_coordinator.cpp: direct GBE_local_lobby field write count 1; route through a named state helper",
            audit.audit_direct_local_lobby_writes(sources),
    ...
    def test_rejects_direct_target_parenthesized_indexed_field_write(self):
        sources = {
            "gbe_dota_custom_game_lifecycle_coordinator.cpp": "(options.client_target->GBE_local_lobby).members[0] = member;",
        }
        self.assertIn(
    ...
    def test_rejects_direct_target_indexed_compound_member_write(self):
        sources = {
            "gbe_dota_custom_game_lifecycle_coordinator.cpp": "options.client_target->GBE_local_lobby.members[0].team += 1u;",
        }
        self.assertIn(
            "gbe_dota_custom_game_lifecycle_coordinator.cpp: direct GBE_local_lobby field write count 1; route through a named state helper",
            audit.audit_direct_local_lobby_writes(sources),
    ...
    def test_rejects_mutable_forwarding_alias_to_local_lobby(self):
        sources = {
            "gbe_dota_lobby_create_handlers.cpp": "auto&& lobby = GBE_local_lobby; lobby.state = 1u;",
        }
        self.assertIn(
    ...
    def test_rejects_decltype_auto_alias_to_local_lobby(self):
        sources = {
            "gbe_dota_lobby_create_handlers.cpp": "decltype(auto) lobby = (GBE_local_lobby); lobby.state = 1u;",
        }
        self.assertIn(
            "gbe_dota_lobby_create_handlers.cpp: mutable GBE_local_lobby alias count 1; route writes through a named state helper",
            audit.audit_direct_local_lobby_writes(sources),
    ...
    def test_rejects_explicit_local_lobby_mutable_alias_to_local_lobby(self):
        sources = {
            "gbe_dota_lobby_create_handlers.cpp": "GBE_LocalLobby& lobby = GBE_local_lobby; lobby.state = 1u;",
        }
        self.assertIn(
            "gbe_dota_lobby_create_handlers.cpp: mutable GBE_local_lobby alias count 1; route writes through a named state helper",
            audit.audit_direct_local_lobby_writes(sources),
